...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO guru (kode_guru, nama, mapel, jkelamin, no_telp, alamat) VALUES ('$kode_guru', '$nama', '$mapel', '$jkelamin', '$no_telp', '$alamat')";
    ...
    if (isset($_POST['update'])) {
        ...
        $query = "UPDATE guru SET nama='$nama', mapel='$mapel', jkelamin='$jkelamin', no_telp='$no_telp', alamat='$alamat' WHERE id='$id'";
        mysqli_query($koneksi, $query);
                ...
                <div class="container p-4">
                    ...
                    <form method="post" class="mb-4 rounded text-black dark:text-white">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 ">
                            ...
                            <select name="mapel" id="mapel" class="rounded px-2 py-1 bg-white dark:bg-gray-900">
                            ...
                            <textarea name="alamat" placeholder="Alamat" required class="rounded px-2 py-1 bg-white dark:bg-gray-900"></textarea>
                        </div>
